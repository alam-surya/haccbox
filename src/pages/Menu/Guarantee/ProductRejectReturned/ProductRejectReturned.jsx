...
function ProductRejectReturned() {
  ...
  const { t } = useLanguage()
  const p = t.pages?.productRejectReturned || {}
  ...
  return (
    <div className="product-reject-returned-page page-hero-dark">
      ...
      <section ref={contentSectionRef} className="product-reject-returned-section">
        <div className="product-reject-returned-container">
          <h2 className="product-reject-returned-title">{p.title}</h2>
          <p className="product-reject-returned-text">{p.text}</p>
        </div>
      </section>
    </div>
  )
