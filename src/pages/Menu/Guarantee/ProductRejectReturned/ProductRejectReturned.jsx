...
import './ProductRejectReturned.css'

gsap.registerPlugin(ScrollTrigger)

function ProductRejectReturned() {
  ...
  return (
    <div className="product-reject-returned-page">
      <section ref={sectionRef} className="hero-content-section">
        <div className="hero-content">
          <div className="hero-content-left">
            <h1 className="hero-heading">Product Reject Returned</h1>
          </div>
      ...
      <section ref={contentSectionRef} className="product-reject-returned-section">
        <div className="product-reject-returned-container">
          <h2 className="product-reject-returned-title">Product Reject Returned</h2>
          <p className="product-reject-returned-text">Content for Product Reject Returned will be added here.</p>
        </div>
      </section>
    </div>
  )
...
export default ProductRejectReturned
